    ...
    <>
      ...
      <main id="content">
        {/* Above the fold on a phone: one headline, one line of subcopy, one
            playable game. Nothing else competes with it. */}
        <section className="mx-auto max-w-3xl px-5 pt-6 pb-4 sm:pt-10 sm:pb-8 md:pt-14">
          ...
          <p className="text-ink-soft mb-4 text-lg sm:mb-6">
            Play one round against a real language model. No sign-up, nothing
            to read first.
          </p>
          <Link
        ...
        {/* The path. Where you are, what's next, and the certificate at the
            end of it — no fork to choose between before any of that. */}
          ...
          <div className="mx-auto max-w-3xl px-5 py-14">
            <Reveal>
              ...
              <p className="prose-measure text-ink-soft mb-9">
                One idea and one game per chapter. Every game makes you commit
                to a guess before it shows you what a real model actually did.
              </p>
            </Reveal>
            <Reveal delay={0.08}>
              <AiPathLine />
        ...
        <section id="puzzle" className="border-ink/25 scroll-mt-20 border-t">
          <div className="mx-auto max-w-3xl px-5 py-14">
            <Reveal>
        ...
        <section className="border-ink/25 bg-paper-sunk border-t">
          <div className="mx-auto max-w-3xl px-5 py-14">
            <Reveal>
              <p className="label text-ink-faint mb-3">If you want to build them</p>
              <h2 className="display-lg mb-4">The craft underneath it.</h2>
            </Reveal>
            <Reveal delay={0.06}>
              <MlPathTeaser />
            </Reveal>
            ...
            <Reveal>
              ...
              <div className="prose-measure text-ink-soft space-y-3">
                <p>
                  ...
                  phrase that is meant to unlock better answers. A rule that
                  you should never trust it with anything that matters. A
                  vague sense that it thinks the way a colleague does. All of
